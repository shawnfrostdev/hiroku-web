  ...
  return (
    <footer className="w-full bg-[#000000] border-t border-[#1F1F1F] mt-auto py-[48px] px-[24px] md:px-[48px] text-[#A3A3A3]">
      <div className="w-full flex flex-col md:flex-row justify-between items-start gap-[32px] md:gap-[64px]">
        ...
        <div className="flex gap-[48px] md:gap-[96px] shrink-0">
          <div className="flex flex-col gap-[12px]">
            <Link href="/browse" className="text-sm font-semibold hover:text-[#FFFFFF] transition-colors">
              Browse
            </Link>
            <Link href="/status" className="text-sm font-semibold hover:text-[#FFFFFF] transition-colors">
              Status
            </Link>
          </div>
          <div className="flex flex-col gap-[12px]">
            <Link href="/donate" className="text-sm font-semibold hover:text-[#FFFFFF] transition-colors">
              Donate
            </Link>
            <Link href="/discord" className="text-sm font-semibold hover:text-[#FFFFFF] transition-colors">
              Discord
            </Link>
          </div>
        </div>
      ...
      <div className="w-full border-t border-[#1F1F1F] mt-[32px] pt-[24px] flex flex-col md:flex-row justify-between items-center gap-[16px] text-xs text-[#525252]">
        <div>
          &copy; {new Date().getFullYear()} <Link href="/" className="hover:underline text-[#737373]">hiroku.com</Link> | Website by <span className="text-[#A3A3A3]">Hiroku Team</span>
        </div>
